		...
		if (entity:GetClass() == "cw_coinslot") then
			...
			if (1 == 1) then
				...
				if (unixTime >= player:GetCharacterData("nextration", 0)) then
					...
					player:SetCharacterData("nextration", unixTime + 30);
				else
...
concommand.Add("cw_CoinslotHeal", function(player, cmd, args)
    local trace = player:GetEyeTrace();
    ...
    if (trace.Entity) then
        ...
        if (entity:GetClass() == "cw_coinslot") then
            ...
            if (1 == 1) then
                ...
                if (unixTime >= player:GetCharacterData("nextration", 0)) then
                    player:SetCharacterData("nextration", unixTime + 1);
                else
                    Schema:EasyText(player, "olive", "You must wait for now.");
                    entity:EmitSound(coinslotSounds[math.random(#coinslotSounds)]);
                end;
            end
        end
			...
			if (1 == 1) then
				...
				if !collectedGear then
					...
					if (unixTime >= player:GetData("nextGear", 0)) then
						if (Schema.towerTreasury and Schema.towerTreasury >= 4000) then
							player:GiveItem(item.CreateInstance("standard_issue_4"), true);
						elseif (Schema.towerTreasury and Schema.towerTreasury >= 3000) then
							player:GiveItem(item.CreateInstance("standard_issue_3"), true);
						elseif (Schema.towerTreasury and Schema.towerTreasury >= 2000) then
							player:GiveItem(item.CreateInstance("standard_issue_2"), true);
						else
							player:GiveItem(item.CreateInstance("standard_issue_1"), true);
						end
						...
						player:SetData("nextGear", unixTime + 30);
