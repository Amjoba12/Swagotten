...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.category = "Melee";
	ITEM.description = "DESC";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/daneaxe.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(0, 12.32, 0);
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/bill.png"
	ITEM.category = "Melee";
	ITEM.description = "DESC";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/war_club.png"
	ITEM.meleeWeapon = true;
...
ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.weight = 8;
	ITEM.uniqueID = "begotten_scrappers_guitar_example";
