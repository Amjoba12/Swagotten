...
local ITEM = Clockwork.item:New("backpack_base");
	ITEM.name = "Cape";
	ITEM.uniqueID = "backpack_shortcape";
	ITEM.model = "models/players/cape_05.mdl";
        ITEM.skin = 5;
	ITEM.weight = 0.5;
	ITEM.invSpace = 30;
	ITEM.description = "A cape that is usually made for noble figures.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
        ITEM.attachmentOffsetAngles = Angle(90, -90, 0);
	ITEM.attachmentOffsetVector = Vector(0, -4.5, -55);
...
local ITEM = Clockwork.item:New("backpack_base");
	ITEM.name = "Fur Cape";
	ITEM.uniqueID = "backpack_furcape";
	ITEM.model = "models/players/cape_11.mdl";
	ITEM.weight = 0.5;
	ITEM.invSpace = 30;
	ITEM.description = "A comfy cape made out of animal fur.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
	ITEM.attachmentOffsetAngles = Angle(90, -90, 0);
	ITEM.attachmentOffsetVector = Vector(0, -5, -58);
...
local ITEM = Clockwork.item:New("backpack_base");
	ITEM.name = "Guilded cape";
	ITEM.uniqueID = "backpack_guildedcape";
	ITEM.model = "models/players/cape_08.mdl";
        ITEM.SetSkin = 5;
	ITEM.weight = 0.5;
	ITEM.invSpace = 30;
	ITEM.description = "A cape with guilded edges that is usually worn by noble figures.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
        ITEM.attachmentOffsetAngles = Angle(90, -90, 0);
	ITEM.attachmentOffsetVector = Vector(0, -3, -57);
...
local ITEM = Clockwork.item:New("backpack_base");
	ITEM.name = "Half-cape";
	ITEM.uniqueID = "backpack_halfcape";
	ITEM.model = "models/players/cape_09.mdl";
        ITEM.SetSkin = 5;
	ITEM.weight = 0.5;
	ITEM.invSpace = 30;
	ITEM.description = "A cape that has minimal clothing";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
        ITEM.attachmentOffsetAngles = Angle(90, -90, 0);
	ITEM.attachmentOffsetVector = Vector(0, -3.5, -57);
