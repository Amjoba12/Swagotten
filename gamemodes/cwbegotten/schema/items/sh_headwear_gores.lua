...
local ITEM = Clockwork.item:New("bodygroup_base")
    ...
    ITEM.iconoverride = "materials/begotten/ui/itemicons/helms/reaver_despoiler_helm.png"
    ITEM.weight = 4.5
    ITEM.headReplacement = "models/begotten/heads/reaver_despoiler_helmet.mdl";
