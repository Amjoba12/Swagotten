...
-- ������� ��� ���������������� ������ ��������� (�������� ����)
local COMMAND = Clockwork.command:New("clearbeliefs");
COMMAND.tip = "Reset your own beliefs.";
COMMAND.text = "";
...
-- ������� ��� ���������������� ��������� ����� (�������� ����)
--local COMMAND = Clockwork.command:New("givexp");
--COMMAND.tip = "Add faith (experience) to yourself.";
--COMMAND.text = "<int Experience>";
--COMMAND.flags = CMD_DEFAULT;
--COMMAND.arguments = 1;

-- Called when the command has been run.
--function COMMAND:OnRun(player, arguments)
 --   local xp = arguments[1];
 ...
 --       xp = tonumber(xp);
  ...
  --      if xp > 0 then
            -- �������� ������ ������ ������
    --        Schema:EasyText(player, "cornflowerblue", "["..self.name.."] You have given yourself "..xp.." experience.");
            -- ����� ����
   --         player:HandleXP(xp, true);
  --      else
  --          Schema:EasyText(player, "grey", "["..self.name.."] You must specify a positive number!");
  --      end
 --   else
 --       Schema:EasyText(player, "grey", "["..self.name.."] You must specify a valid number!");
 --   end
...
local COMMAND = Clockwork.command:New("Warcry");
	...
	function COMMAND:OnRun(player, arguments)
		...
		if player:GetNetVar("kinisgerOverride") then
			...
			elseif (clothesItem) and clothesItem.attributes and table.HasValue(clothesItem.attributes, "judgement") then
                warcry_beliefs = {}
                player_has_belief = true
		...
		if player_has_belief or subfaction == "Clan Grock" then
			...
			if (!player.lastWarCry) or player.lastWarCry < curTime then
				...
				if (clothesItem) and clothesItem.attributes and table.HasValue(clothesItem.attributes, "judgement") then
					Clockwork.chatBox:AddInTargetRadius(player, "me", "lets out a hallowed cry for judgement!", playerPos, radius);
					if player:GetGender() == GENDER_MALE then
						player:EmitSound("player/warcries/orthodoxist/male/warcry"..math.random(1, 10)..".mp3", 100, math.random(90, 105));
					else
						player:EmitSound("player/warcries/orthodoxist/female/warcry"..math.random(1, 10)..".mp3", 100, math.random(90, 105));
					end
					...
					if activeWeapon:GetClass() == "cw_lantern" and player:HasBelief("extinctionist") then
						...
						if weaponItemTable then
							...
							if currentOil >= 1 then
								...
								local clothesItem = player:GetClothesEquipped();
								if clothesItem and clothesItem.attributes and table.HasValue(clothesItem.attributes, "burninghatred") then
									player:Ignite(30);
								else
									player:Ignite(15);
								end
