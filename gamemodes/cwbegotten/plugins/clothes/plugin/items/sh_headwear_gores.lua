...
local ITEM = Clockwork.item:New("bodygroup_base")
	ITEM.name = "Shagalaxian Dragonscale helm"
	ITEM.model = "models/begotten_prelude/items/shagalaxchief_helm.mdl"
	ITEM.iconoverride = "materials/begottenprelude/ui/itemicons/shagalaxchief_helm.png"
	ITEM.weight = 3
	ITEM.uniqueID = "gore_shagalaxian_chief_helm"
	ITEM.category = "Helms"
	ITEM.headReplacement = "models/begotten/heads/shagalaxchief_helmet.mdl";
	ITEM.headSuffix = "_gore";
	ITEM.description = "A steel ridge helm that has been proven in combat. Only a worthy Shagalaxian may wear it."
	ITEM.requiredFactions = {"Goreic Warrior"};
	ITEM.useSound = "armor/plate_damage_02.wav";
	ITEM.overlay = "begotten/zomboverlay/new/goreridgehelm";
	...
	ITEM.pierceScale = 0.70; -- reduces pierce damage by 30%
	ITEM.slashScale = 0.60; -- reduces slash damage by 40%
	ITEM.bulletScale = 0.50; -- reduces bullet damage by 35%
