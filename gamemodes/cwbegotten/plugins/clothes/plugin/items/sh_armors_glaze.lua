...
local ITEM = Clockwork.item:New("clothes_base");
ITEM.name = "Orthodox hierarch armor";
ITEM.model = "models/begotten/armor/orthodoxist_hierarch_armor.mdl"
ITEM.iconoverride = "materials/begotten/ui/itemicons/armor/orthodoxist_hierarch_armor.png"
ITEM.uniqueID = "orthodox_hierarch"
ITEM.category = "Armor"
ITEM.conditionScale = 0.75
ITEM.concealsFace = true;
ITEM.hasHelmet = true;
...
ITEM.type = "plate";
ITEM.permanent = true; 
ITEM.description = "The once pristine armor of nobility, now reduced to a burnt set of plate fused with the anger of its previous owner. There lay great potential in this armor, should one sufficiently want to fucking die. It constantly bleeds because of metal spikes that pierces through your body once you decide to fuse with this cage filled with hatred to the brim.";
ITEM.useSound = "armormovement/body-armor-b4.WAV.mp3";
ITEM.excludedfactions = {"Goreic Warrior"};
ITEM.overlay = "begotten/zomboverlay/new/knighthelmet";
ITEM.helmetIconOverride = "materials/begotten/ui/itemicons/helms/orthodoxist_hierarch_armor.png"

ITEM.requiredbeliefs = {"hauberk", "repentant"};

ITEM.attributes = {"not_unequippable", "solblessed", "burninghatred", "judgement", "conditionless", "fear"};
...
function ITEM:GetReplacement(player)
	--if (player:GetGender() == GENDER_FEMALE) then
		return "models/begotten/gatekeepers/orthodoxist_hierarch_armor.mdl";
	--else
		--return "models/begotten/gatekeepers/highgatekeeper02.mdl";
	--end;
end;
