...
local ITEM = Clockwork.item:New("clothes_base");
ITEM.name = "Dragonscale Shagalaxian armor";
ITEM.group = "goreicwarfighters/shagalaxchief";
ITEM.model = "models/begotten_prelude/items/shagalaxchief_armor.mdl"
ITEM.iconoverride = "materials/begottenprelude/ui/itemicons/shagalaxchief_armor.png"
ITEM.category = "Armor"
ITEM.conditionScale = 0.75
ITEM.hitParticle = "MetalSpark";
ITEM.protection = 75;
...
ITEM.weightclass = "Heavy";
ITEM.type = "chainmail";
ITEM.description = "The armor of a Shagalaxian chief: a combination of chainmail and shagalaxian scale armor, with ornate leather decorations.";
ITEM.useSound = "armormovement/body-armor-b4.WAV.mp3";
ITEM.requiredFactions = {"Goreic Warrior"};
ITEM.excludedSubfactions = {"Clan Grock", "Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast"};
...
ITEM.runSound = {
	"player/footsteps/red_wolf/run1.wav",
	"player/footsteps/red_wolf/run2.wav",
	"player/footsteps/red_wolf/run3.wav",
	"player/footsteps/red_wolf/run4.wav",
	"player/footsteps/red_wolf/run5.wav",
	"player/footsteps/red_wolf/run6.wav",
    "player/footsteps/red_wolf/run7.wav",
	"player/footsteps/red_wolf/run8.wav",
	"player/footsteps/red_wolf/run9.wav",
	"player/footsteps/red_wolf/run10.wav",
};

ITEM.walkSound = {
	"player/footsteps/red_wolf/walk1.wav",
	"player/footsteps/red_wolf/walk2.wav",
};
...
ITEM:Register();
local ITEM = Clockwork.item:New("clothes_base");
ITEM.name = "Old Ways armor";
ITEM.model = "models/begotten/armor/old_ways_armor.mdl"
ITEM.iconoverride = "materials/begotten/ui/itemicons/armor/armor_of_the_old_ways.png"
ITEM.category = "Armor"
ITEM.hasHelmet = true;
ITEM.conditionScale = 0.75
ITEM.hitParticle = "MetalSpark";
ITEM.protection = 85;
ITEM.weight = 11;
ITEM.weightclass = "Super heavy";
ITEM.type = "plate";
ITEM.description = "Heaviest armor known amongst goreic warfighters, that ironically, only used by Clan Grock.";
ITEM.useSound = "armormovement/body-armor-b4.WAV.mp3";
ITEM.requiredFactions = {"Goreic Warrior"};
ITEM.excludedSubfactions = {"Clan Harald", "Clan Gore", "Clan Shagalax", "Clan Crast", "Clan Reaver"};
ITEM.helmetIconOverride = "materials/begotten/ui/itemicons/helms/armor_of_the_old_ways.png"
...
ITEM.damageTypeScales = {
	[DMG_FALL] = -0.40, -- increases fall damage by 40%
}
...
-- Called when a replacement is needed for a player.
function ITEM:GetReplacement(player)
	return "models/begottenprelude/goose/oldways.mdl";
end;
