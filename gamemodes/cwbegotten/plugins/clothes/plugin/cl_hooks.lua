...
function PLUGIN:GetBars(bars)
	...
	if clothesItem and clothesItem.attributes and table.HasValue(clothesItem.attributes, "burninghatred") then
		bars:Add("BURNING HATRED", Color(255, 69, 0, 255), "BURNING HATRED", self.hatred, 100, self.hatred == 100);
	elseif clothesItem and clothesItem.attributes and table.HasValue(clothesItem.attributes, "solblessed") then
