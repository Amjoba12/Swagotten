...
SWEP.VElements = {
	["dragoon"] = { type = "Model", model = "models/weapons/begotten/dragoon.mdl", bone = "v_ee3_reference001", rel = "", pos = Vector(0.2, -2, 1.5), angle = Angle(0, -90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["cycler"] = { type = "Model", model = "models/weapons/begotten/dragoon.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, -1.201), angle = Angle(180, 0, -8), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.Gun = ("begotten_deadlanderdragoon")					-- must be the name of your swep
...
SWEP.PrintName				= "Deadlander Dragoon"	-- Weapon name (Shown on HUD)	
...
SWEP.AmmoTypes = {
	["Pop-a-Shot"] = function(SWEP)
		SWEP.Primary.Sound = Sound("dragoon/dragoon_fire_pop_"..math.random(1,3)..".wav");
		SWEP.Primary.FarSound = Sound("dragoon/dragoon_fire_pop_1_distant.wav");
		SWEP.Primary.SoundLevel = 480;
	...
	["Scrapshot"] = function(SWEP)
		SWEP.Primary.Sound = Sound("dragoon/dragoon_fire_scrap_"..math.random(1,3)..".wav");
		SWEP.Primary.FarSound = Sound("dragoon/dragoon_fire_scrap_1_distant.wav");
		SWEP.Primary.SoundLevel = 480;
		SWEP.Primary.NumShots = 1;
