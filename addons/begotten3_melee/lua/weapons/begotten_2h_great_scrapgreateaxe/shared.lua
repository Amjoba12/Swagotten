...
SWEP.PrintName = "Scrapper War Axe"
...
SWEP.VElements = {
	["v_gorefalx"] = { type = "Model", model = "models/weapons/greataxe_scrap.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(0, 0, 4), angle = Angle(90, 198, 90), size = Vector(0.91, 0.91, 0.91), material = "", skin = 0, bodygroup = {[0] = 3} }
}

SWEP.WElements = {
	["w_gorefalx"] = { type = "Model", model = "models/weapons/greataxe_scrap.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.949, -0.5, 2.142), angle = Angle(-5.844, 106.363, 3.506), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {[0] = 3} }
}