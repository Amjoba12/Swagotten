...
SWEP.MultiHit = 3;
SWEP.ChoppingAltAttack = true;  -- <-- ДОБАВЛЕНО (включает альтернативную атаку)
...
-- НОВАЯ ФУНКЦИЯ ДЛЯ THRUST/ALT АТАКИ
function SWEP:HandleThrustAttack()
	...
	-- Используем анимацию, совместимую с этой вью-моделью
	self.Weapon:SendWeaponAnim(ACT_VM_SECONDARYATTACK)
