...
SWEP.VElements = {
	["v_guitar"] = { type = "Model", model = "models/mad_max/guitar_warriot.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(1, -0.519, -0.519), angle = Angle(-1.7, 0, 129.741), size = Vector(0.8, 0.8, 0.8), material = "", skin = 0, bodygroup = {} }
}

SWEP.VElementsAlternate = {
	["v_guitar"] = { type = "Model", model = "models/mad_max/guitar_warriot.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(0, -12.5, 0), angle = Angle(100, -100, -100), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["w_guitar"] = { type = "Model", model = "models/mad_max/guitar_warriot.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.099, -0.201, -10.91), angle = Angle(30, 70, -95), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElementsAlternate = {
	["w_guitar"] = { type = "Model", model = "models/mad_max/guitar_warriot.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.199, -1.9, 27.142), angle = Angle(-5.7, -170, 259.741), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.Gun = ("begotten_guitar")					-- must be the name of your swep
...
SWEP.PrintName				= "Stage Breaker"	-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Damage			= 666		-- Base damage per bullet
...
SWEP.AttackSoundTable = "GuitarAttackSoundTable"
SWEP.BlockSoundTable = "MetalBlockSoundTable"
SWEP.SoundMaterial = "Metal" -- Metal, Wooden, MetalPierce, Punch, Default
SWEP.noDisarm = true;

SWEP.bannerType = "scrap"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "GuitarAttackTable"
SWEP.BlockTable = "GuitarBlockTable"

local bannerDistance = (824 * 824);
SWEP.isMeleeFirearm = true;

SWEP.AmmoTypes = {
	["Cut Blood Diamond"] = function(SWEP)
