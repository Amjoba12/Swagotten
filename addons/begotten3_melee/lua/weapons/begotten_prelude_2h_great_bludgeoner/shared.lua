...
SWEP.VElements = {
	["v_bludgeoner"] = { type = "Model", model = "models/weapons/peasantstar/bludgeoner.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.493, 1.48, 14.321),  angle = Angle(-94.445, -65.556, -32.223), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_bludgeoner"] = { type = "Model", model = "models/weapons/peasantstar/bludgeoner.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.299, 1.899, -6.421), angle = Angle(85, 90, 10), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}