...
SWEP.VElements = {
	["v_goedendag"] = { type = "Model", model = "models/begotten/weapons/goedendag.mdl", bone = "RW_Weapon", rel = "",  pos = Vector(0, 0.5, 0.493), angle = Angle(90, -65.556, -32.223), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_goedendag"] = { type = "Model", model = "models/begotten/weapons/goedendag.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "",  pos = Vector(3.099, 1.1, 0),angle = Angle(-81.112, -41.112, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}