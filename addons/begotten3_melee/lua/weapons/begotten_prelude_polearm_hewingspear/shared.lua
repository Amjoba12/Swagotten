...
-- ОСНОВНАЯ АТАКА (теперь размашистый горизонтальный удар)
function SWEP:HandlePrimaryAttack()

	local attacksoundtable = GetSoundTable(self.AttackSoundTable)
	local attacktable = GetTable(self.AttackTable)

	--Attack animation (горизонтальный размашистый удар)
...
-- АЛЬТЕРНАТИВНАЯ АТАКА (теперь тычок/прицельный удар)
function SWEP:HandleThrustAttack()

	local attacksoundtable = GetSoundTable(self.AttackSoundTable)
	local attacktable = GetTable(self.AttackTable)

	--Attack animation (тычок)
